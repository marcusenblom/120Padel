 ...
 export default function SerieNavigation(props: ISerieNavigation){
    ...
    let serieButtonContainer = (
        <div className="serie-button-container">
            <button type="button" className="serie-button" onClick={props.showSerie}>Poängställning</button>
            <button type="button" className="serie-button" onClick={props.showMatchesPlayed}>Spelade matcher</button>
        </div>
    );
